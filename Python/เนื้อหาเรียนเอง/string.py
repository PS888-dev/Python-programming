...
# ฟังก์ชันจัดการสตริง
# """upperพิมพ์ใหญ่/lowerพิมพ์เล็ก 
# startswith ตรวจสอบว่าข้อความขึ้นต้นด้วยคำที่กำหนดหรือไม่
# endswith ตรวจสอบว่าข้อความลงท้ายด้วยคำที่กำหนดหรือไม่
# """
...
# '''find ตรวจสอบว่ามีคำที่กำหนดอยู่ในข้อความหรือไม่ 
# ถ้ามีจะคืนค่าเป็นตำแหน่งของคำที่พบ ถ้าไม่พบจะคืนค่าเป็น -1 count 
# นับจำนวนคำที่กำหนดในข้อความ
# '''
# text2="สวัสดี คุณป้า คุณน้า คุณตา คุณยาย"
# print(text2.find("คุณ"))
# print(text2.count("คุณ"))
